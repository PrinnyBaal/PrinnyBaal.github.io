...
openingTutorial.addFrame("After you've added or removed any gems from the trays you'll have to update the sheets.  To do that just click the button labeled 'Update Display' on the fist sheet.  It should start glowing and moving to remind you to do so after any gems are moved or other changes are made.", "floatText", ["#lapidary", "#infoSlot", "#dieHolder", "#resultBox", "#gemTray", "#miscMod"]);
